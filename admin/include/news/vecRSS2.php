...
<?php
    ...
    class fteFeed{
        public function vec(){
            $httpUrl = 'http://www.dek-d.com/education/more.php?cate=12';
            ...
            if($regexStatus=='200' || $regexStatus=='302'){
                $url = iconv("windows-874", "UTF-8", $url );
                if (preg_match_all("/<a href=\"\/education\/(.+)\" title=\"(.+)\"><img/", $url,$matches)) {
                    $link   = $matches[1];
                    $title  = $matches[2];
                }
            }else{
...
<img src='../../assets/img/arrow.png'/>
                ...
                print "<td>
<a href='http://www.dek-d.com/education/$link[$i]' target='_blank'>$title[$i]</a>
                </td>";
                print "</tr>";
}
?>
